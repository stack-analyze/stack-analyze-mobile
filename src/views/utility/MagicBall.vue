  ...
  <ion-page>
    ...
    <ion-content>
      <ion-grid>
        <ion-row>
          <ion-col size="6">
            <ion-input autocomplete="off" color="secondary" label="enter a question" label-placement="floating"
              v-model="question" />
          </ion-col>
          <ion-col size="6">
        ...
        <stack-buttons init-btn-name="start magic ball" :init-validate="question.length <= 10"
          @init-function="initMagicBall" clear-btn-name="clear question" :clear-validate="magicBall!.reading === ''"
