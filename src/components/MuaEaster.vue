        ...
        <ion-content>
            <ion-card mode="ios">
                            <ion-card-header mode="md">
                                <ion-img 
                                    src="assets/img/mua-discovery.jpg" 
                                    alt="mua profile"
                                    class="profile-info"
                                >
                                </ion-img>
                                <ion-card-title>la mua</ion-card-title>
                                <ion-card-subtitle>make up artist and section mua discovery</ion-card-subtitle>
                            </ion-card-header>
                            <ion-card-content mode="md">
                                <ion-button
                                    v-for="social of muaSocial"
                                    fill="clear"
                                    :key="social.color"
                                    :href="social.link"
                                    target="_blank"
